...
sections = read_sections_from_docx(gt_file)
print()
...
title_section = sections[5]
print('title_section',title_section)
...
print('test',contents)
P,R,F1 = aligned_bert_score(contents,title_section)
print(P,R,F1)

'''
gt_file =r"D:\All_self_files\info_extract_examples\621 pdf test\digital\compare1\ground_truth2.docx"
gt_paras =  read_paragraphs_from_docx(gt_file)

pdf_file = r"D:\All_self_files\info_extract_examples\621 pdf test\digital\compare1\liu-et-al-2022-synthesis-of-3-trifluoromethyl-1-2-4-triazolines-and-1-2-4-triazoles-via-tandem-addition-cyclization-of.pdf"
